const getHorizontalCells = (matrix, row, col) => {
...
const getVerticalCells = (matrix, row, col) => {
  const value = matrix[row][col];
  const cells = [];
  let tempRow = row;
...
const getDiagonalCells = (matrix, row, col) => {
  const value = matrix[row][col];
  const cells = [];
  let tempRow = row;
  let tempCol = col;
...
const getInverseDiagonalCells = (matrix, row, col) => {
  const value = matrix[row][col];
  const cells = [];
  let tempRow = row;
  let tempCol = col;
